...
try:
    ...
    from detection.lidar import detect_lines as _detect_lines, shape_metrics, Line
...
TOOLS: Dict[str, Any] = {
    ...
    "scan_lidar_area": scan_lidar_area,
    "scan_area": scan_area,
    "scan_tiles_concurrent": scan_tiles_concurrent,
}
